            ...
            <div class="card-body">
                ...
                <form action="{{route('penjualan.store')}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-5 col-5 mt-0 ml-5">
                            <label for="tgl">Tanggal<code>*)</code></label>
                                ...
                                is_invalid
                            @enderror" value="{{old('tgl')?old('tgl'):date('Y-m-d')}}" name="tgl">
                        ...
                        <div class="form-group col-md-5 col-5 mt-0 ml-5">
                          ...
                          <div class="form-group col-md-5 col-5 mt-0 ml-5">
                            ...
                            <input type="number" min="0" name="jml_terjual" id="jml_terjual" class="form-control @error('jml_terjual') is-invalid @enderror" value="{{old('jml_terjual')}}" required>
                    ...
                    {{-- <div class="form-group col-md-5 col-5 mt-0 ml-5">
                        ...
                        <input type="number" min="0" name="jml_produk_diolah_perbulan" id="jml_produk_diolah_perbulan" class="form-control @error('jml_produk_diolah_perbulan') is-invalid @enderror" value="{{old('jml_produk_diolah_perbulan')}}" required>
                    ...
                    <div class="form-group col-md-5 col-5 mt-0 ml-5">
                        ...
                        <input type="number" min="0" name="jml_produk_terjual_perbulan" id="jml_produk_terjual_perbulan" class="form-control @error('jml_produk_terjual_perbulan') is-invalid @enderror" value="{{old('jml_produk_terjual_perbulan')}}" required>
                    ...
                    <div class="form-group col-md-5 col-5 mt-0 ml-5">
                        ...
                        <input type="number" min="0" name="jml_rugilaba" id="jml_rugilaba" class="form-control @error('jml_rugilaba') is-invalid @enderror" value="{{old('jml_rugilaba')}}" required>
