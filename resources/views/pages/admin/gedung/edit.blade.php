    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('gedung.update',$id->id)}}" method="post">
                    @method('put')
                    @csrf
                    ...
                    <div class="form-group col-md-5 col-5 mt-0 ml-5">
                        ...
                        <input type="text" class="form-control  @error('lantai') is-invalid @enderror" name="lantai" required  value="{{old('lantai') ? old('lantai') : $id->lantai}}">
