            ...
            <div class="card-body">
                ...
                <form action="{{route('hasilpanen.update',$id->id)}}" method="post">
                    ...
                    <div class="form-group col-md-5 col-5 mt-0 ml-5">
                        <label for="nama">Nama hasilpanen <code>*)</code></label>
                    ...
                    <div class="form-group col-md-5 col-5 mt-0 ml-5">
                        ...
                        <input type="number" name="stok" id="stok" class="form-control @error('stok') is-invalid @enderror" value="{{old('stok') ? old('stok') : $id->stok}}" required>
                    ...
                    <div class="form-group col-md-5 col-5 mt-0 ml-5">
                        ...
                        <input type="number" min="1"  name="hargajual" id="hargajual" class="form-control @error('hargajual') is-invalid @enderror"  value="{{old('hargajual') ? old('hargajual') : $id->hargajual}}" required>
