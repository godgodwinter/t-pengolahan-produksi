...
class adminpegawaicontroller extends Controller
{
    public function index(Request $request)
    {
        #WAJIB
        $pages='pegawai';
        $datas=DB::table('users')->where('tipeuser','pegawai')
    ...
    public function cari(Request $request)
    {
        ...
        ->where('name','like',"%".$cari."%")->where('tipeuser','pegawai')
        ->orWhere('email','like',"%".$cari."%")->where('tipeuser','pegawai')
        ->orWhere('username','like',"%".$cari."% ")->where('tipeuser','pegawai')
        ->paginate(Fungsi::paginationjml());
    ...
    public function create()
    {
        ...
        return view('pages.admin.pegawai.create',compact('pages'));
    }
